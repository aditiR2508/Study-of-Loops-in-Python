...
# Theory:
### Looping is a control structure that allows a set of statements to be executed repeatedly based on a condition or over a sequence. Python provides two main types of loops: for loop and while loop.
### 1.	For Loop
...
# Conclusion :
From this experiment, we have successfully studied and implemented the for and while loops using Python programs. We have also studied Break, Continue and Pass function in for and while loops in Python programs.
